...
|---|---|---|---|
| MoGe-2 (`microsoft/MoGe` @ 925b8ed, weights `Ruicheng/moge-2-vitl-normal`) | Single-image metric geometry, intrinsics | MIT (code and weights) | Pinned pre-V3 commit (gate G1) |
